...
public class bayonet_ui_component {
    //        protected TooltipMakerAPI tooltip;
    Logger log = Global.getLogger(bayonet_ui_component.class);
    ...
    public HashMap<String, bayonet_ui_component> subComponentMap = new HashMap<>();
    public HashMap<String, List<bayonet_ui_component>> subComponentListMap = new HashMap<>();
     ...
     */
    public bayonet_ui_component(HashMap<String, bayonet_ui_component> componentMap, CustomPanelAPI creatorPanel, float width, float height, float x, float y, boolean addToCreatorPanel, String thisComponentMapKey) {
     ...
     */
    public void attachSubPanel(String tooltipKeyAttachTo, String otherComponentMapKey, bayonet_ui_component otherComponent) {
     ...
     * @param locationY            Y
     */
    public void attachSubPanel(String tooltipKeyAttachTo, String otherComponentMapKey, bayonet_ui_component otherComponent, float locationX, float locationY) {
